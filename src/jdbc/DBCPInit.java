...
public class DBCPInit extends HttpServlet {
	...
	private void initConnectionPool(){
		try{
			...
			//"jdbc:mysql://10.104.104.235:3306/gondr?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Seoul";
			String dbUser = getInitParameter("user");
		...
		System.out.println("커넥션 풀이 생성되었습니다.");
	}
